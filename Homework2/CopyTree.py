...
def deep_copy(tree):
    new_tree = BinarySearchTree(tree.data)
    curr_left = tree.left
    curr_right = tree.right
    while curr_left:
        new_tree.insert(curr_left.left.data)
        new_tree.insert(curr_left.right.data)
        curr_left = curr_left.left
    while curr_right:
        new_tree.insert(curr_right.left.data)
        new_tree.insert(curr_right.right.data)
